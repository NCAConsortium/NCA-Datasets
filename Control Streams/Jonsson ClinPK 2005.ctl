...
;****                   DATASET                          ****
;************************************************************
$INPUT C ID TRT NTIM NTAD=DROP TIME TAD=DROP DOSE AMT DUR RATE=DROP SS II DV MDV EVID CMT WTKG CRCL

$DATA NMDATA IGNORE=@ ; NMDATA = analysis.data.set_28JUN2016.csv

; C:    Comment (Any row starting with a 'C' will be ignored)
; ID:   NONMEM Subject Identification Number 
; TIME: Actual Time Field
; AMT:  Intravenous Dosage Amount Data Item (umol)
; DV:   Dependent Variable (umol/L);
...
$TABLE                                       ; STANDARD TABLE
       C ID NTIM TIME DOSE AMT DUR EVID MDV CMT 
       CRCL WTKG
